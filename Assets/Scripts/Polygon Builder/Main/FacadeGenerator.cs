...
public class FacadeGenerator
{
    ...
    public FacadeGenerator(PolygonBuildingGeneratorMain settings, List<PolygonVertexData> vertexData, List<PolygonSideData> sideData, BuildingStyleSO buildingStyle)
    {
        _settings = settings;
